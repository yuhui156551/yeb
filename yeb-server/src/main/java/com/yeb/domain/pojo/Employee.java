...
public class Employee implements Serializable {
    ...
    /**
     * 数据库 String（带秒） --> LocalDate（不带秒）
     */
    @ApiModelProperty(value = "出生日期")
    @JsonFormat(pattern = "yyyy-MM-dd", timezone = "Asia/Shanghai")
    @Excel(name = "出生日期", width = 20, format = "yyyy-MM-dd")// width = 20 设置长度，format 格式化
    ...
    // 因为数据库只存储了民族的 id，不将 id 打印，需要将 nation 表的 name 字段打印
